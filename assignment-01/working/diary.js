...
(function (exports, $) {
    function showEntries () {
        ...
        // possible for malicious users to inject javascript into webpage, however in current state it will only affect user that does it
        // on the other hand, as it stands it allows other users to post links and style their posts with html
